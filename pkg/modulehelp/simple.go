...
func knownDescription(name string) (string, bool) {
	descriptions := map[string]string{
		...
		"BUS_PORTAL_FRONTEND_AUTH_RESOURCE":      "Identities resource required before serving protected Bus portal frontend assets.",
		...
		"BUS_API_IDENTITIES_API_URL":             "Identities API URL used by providers for binary resource access checks.",
		"BUS_API_IDENTITIES_API_TOKEN":           "Bearer token used by providers when calling the identities API.",
		"BUS_API_IDENTITIES_API_TOKEN_FILE":      "Path to a file containing the identities API bearer token.",
